...
class HybridTrainer:
    ...
    def _log_episodes(self, rollout: Dict[str, Any], iteration: int) -> Tuple[float, float]:
        ...
        if len(self.episode_rewards) > 0:
            ...
            if self.episode_reward_breakdowns:
                ...
                keys = ["tick", "hit", "hurt", "kill", "death", "terminalWin", "terminalLoss", "timeout", "wastedShot", "aimJitter", "approach"]
                summary: List[str] = []
                for key in keys:
    ...
    def train(self, target_episodes: int = 10_000, max_timesteps: int = 20_000_000) -> None:
        ...
        csv_writer.writerow([
            ...
            "avg_tick_50", "avg_hit_50", "avg_hurt_50", "avg_kill_50", "avg_death_50", "avg_terminal_win_50", "avg_terminal_loss_50", "avg_timeout_50", "avg_wasted_shot_50", "avg_aim_jitter_50", "avg_approach_50",
        ...
        try:
            while self.total_episodes < target_episodes and self.total_timesteps < max_timesteps:
                ...
                if self.episode_reward_breakdowns:
                    ...
                    avg_tick = avg_hit = avg_hurt = avg_kill = avg_death = avg_terminal_win = avg_terminal_loss = avg_timeout = avg_wasted_shot = avg_aim_jitter = avg_approach = 0.0
                ...
                if phase_transition is not None:
                    ...
                    for key in ["tick", "hit", "hurt", "kill", "death", "terminalWin", "terminalLoss", "timeout", "wastedShot", "aimJitter", "approach"]:
                        vals = [float(b.get(key, 0.0)) for b in recent_breakdowns]
